...
{
    [TestFixture]
    public class When_executing_the_turn_right_command_with_a_current_orientation_of_N
    {
        ...
        public void BecauseOf()
        {
            ...
            new TurnRightCommand().Execute(_rover);
        }
    ...
    [TestFixture]
    public class When_executing_the_turn_right_command_with_a_current_orientation_of_E
    {
        private Rover _rover;
    ...
    [TestFixture]
    public class When_executing_the_turn_right_command_with_a_current_orientation_of_S
    {
        private Rover _rover;
    ...
    [TestFixture]
    public class When_executing_the_turn_right_command_with_a_current_orientation_of_W
    {
        private Rover _rover;
